        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="signup-user.php" method="POST" autocomplete="">
					...
					<div class="form-group">
					<label>
						<input type="checkbox" id="accept-terms" required> By joining Erovoutika, you agree to our <b>Terms of <br> Service</b> and <b>Privacy Policy</b>
					</label>
					</div>
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="signup" value="Create Account">
                    </div>
                    <div class="signin-acc">Already have an account? <a href="login-user.php">Sign In</a></div>
                </form>
            </div>
        </div>
    </div>
